...
router.post("/", (req, res) => {
  ...
  Product.create(productData, (error, createdProduct) => {
    // creates a product using the data from our body
    ...
    if (error) {
      ...
      User.updateOne(
        {
          // updates the user that sold the product
        ...
        (error, updatedUser) => {
          ...
          if (error) {
            ...
            console.log(
              "successfully created a product and added to the user sold list"
            );
            res.status(201).json({
        ...
        User.updateOne(
          ...
          (error, updatedUser) => {
            ...
            if (error) {
              ...
              console.log(
                "Successfully deleted the product and removed it from user's sold products"
              );
