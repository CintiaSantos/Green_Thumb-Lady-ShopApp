              ...
              Product.updateMany(
                ...
                (error, updatedProduct) => {
                  ...
                  if (error) {
                    ...
                    console.log(
                      `Successfully deleted ${resultA.deletedCount} products that were sold by the User.`
                    );
                    User.deleteOne(
                      {
                        // deletes one user
        ...
        Product.updateOne(
          ...
          (error, updatedProduct) => {
            ...
            if (error) {
              ...
              res.status(202).json({
                message:
                  "Successfully updated the user and product favorite lists",
